...
.loader:before {
  ...
  animation: themeRect var(--duration) cubic-bezier(0.785, 0.135, 0.15, 0.86)
    infinite;
}
...
.loader svg polygon {
  ...
  stroke-dashoffset: 0;
  animation: RealTriangle var(--duration) cubic-bezier(0.785, 0.135, 0.15, 0.86)
    infinite;
}
